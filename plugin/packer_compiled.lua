...
_G.packer_plugins = {
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["nvim-ts-context-commentstring"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/opt/nvim-ts-context-commentstring",
